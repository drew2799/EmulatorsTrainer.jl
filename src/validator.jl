...
function sort_residuals(residuals, n_output, n_elements)
    ...
    final_residuals[1,:] = sorted_residuals[trunc(Int, (2746*0.68)),:]
    final_residuals[2,:] = sorted_residuals[trunc(Int, (2746*0.95)),:]
    final_residuals[3,:] = sorted_residuals[trunc(Int, (2746*0.99)),:]
