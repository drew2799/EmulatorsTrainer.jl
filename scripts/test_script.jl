...
@everywhere using NPZ, EmulatorsTrainer, JSON3

pars = ["a", "b", "c"]
lb = [0., 0., 0.]
ub = [1., 1., 1.]
n = 1000
@everywhere s = EmulatorsTrainer.create_training_dataset(n, lb, ub)

root_dir = "/home/mbonici/test_emu"

@everywhere function test_script(my_dict::Dict, root_path)
    a = my_dict["a"]
    b = my_dict["b"]
    c = my_dict["c"]
